          ...
          <div className="max-w-7xl mx-auto px-4">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-8 mb-8">
                  <div className="flex justify-between items-start">
                      <div>
                          <h1 className="text-4xl font-bold text-gray-800 mb-2">Raghav Grover</h1>
                          <h2 className="text-xl text-blue-600 font-semibold mb-4">Senior Technology Architecture Leader</h2>
                      ...
                      <div className="text-right space-y-2">
                          <div className="flex items-center justify-end gap-2">
                              ...
                              <span>raghavgrover13@icloud.com</span>
                          </div>
                          <div className="flex items-center justify-end gap-2">
                              <Phone size={18} className="text-blue-600" />
                              <span>+1-732-997-5241</span>
                          </div>
                          <div className="flex items-center justify-end gap-2">
